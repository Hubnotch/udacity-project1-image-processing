...
describe('Test suite for processing images', () => {
    it('should resolve if the correct filename, width and height are provided', () => __awaiter(void 0, void 0, void 0, function* () {
        yield expectAsync((0, imageProcessingFunc_1.default)('palmtunnel', 500, 500)).toBeResolved();
    }));
    it('should reject if incorrect filename', () => __awaiter(void 0, void 0, void 0, function* () {
        yield expectAsync((0, imageProcessingFunc_1.default)('noFileName', 500, 500)).toBeRejected();
    }));
});
